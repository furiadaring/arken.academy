...
export default async function CheckoutPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      <div className="bg-background/20 border-card rounded-[40px] border px-3 py-8 shadow-[0px_4px_34px_0px_#FFFFFF0D_inset] backdrop-blur-[25px] lg:px-6">
        <SectionTitle className="text-accent mb-8 text-center text-[24px] lg:!text-[32px]">
          {t('orderComplete')}
        </SectionTitle>

        <div className="space-y-6">
          <div className="border-card flex items-center justify-between border-b pb-4">
